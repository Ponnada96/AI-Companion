        ...
        <div role="status" className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-2 pb-10 animate-pulse">
            {
                Array.from({ length: 10 }, (_, index) => (
                    <div className="flex flex-col items-center bg-primary/10 rounded-xl  transition border-0">
                        <div className="flex flex-col gap-2 items-center p-6">
                            ...
                            <div className="h-4 bg-gray-200 rounded-full dark:bg-gray-700 w-28 " />
                            <div className="space-y-2">
                                <div className="h-4 bg-gray-200 rounded-full dark:bg-gray-700 w-44 mt-3 "></div>
                                <div className="h-4 bg-gray-200 rounded-full dark:bg-gray-700 w-32 "></div>
                            </div>
                        </div>
                        <div className="flex w-full  justify-between p-6 pt-0">
                            <div className="h-4 bg-gray-200 rounded-full dark:bg-gray-700 w-20 mt-3 "></div>
                            <div className="h-4 bg-gray-200 rounded-full dark:bg-gray-700 w-8 mt-3 ">
                            </div>
                        </div>
                    </div>
                ))
